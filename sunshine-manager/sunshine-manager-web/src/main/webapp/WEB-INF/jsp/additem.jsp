    ...
    <div class="span12">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/item/save" method="post" id="itemform" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">商品名 :</label>
              <div class="controls">
                <input type="text" name="title" class="span11" placeholder="商品名" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">卖点 :</label>
              <div class="controls">
                <input type="text" name="sellPoint" class="span11" placeholder="9块9包邮" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">库存量  :</label>
              <div class="controls">
                <input type="text" name="num" class="span11" placeholder="100"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">单价 :</label>
                <div class="controls">
                  <input type="text" name="price" placeholder="5.000" class="span11">
            ...
            <div class="control-group">
              <label class="control-label">商品图片 :</label>
                <div class="controls">
                  <input type="file" placeholder="选择商品图片" class="span11">
                </div>
            </div>
