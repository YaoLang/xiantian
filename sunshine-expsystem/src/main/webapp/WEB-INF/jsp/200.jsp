...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>首页</a> <a href="#">状态</a> <a href="#" class="current">成功</a> </div>
    <h1>Success 200</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content">
            <div class="error_ex">
              <h1>200</h1>
              <h3>操作成功!</h3>
              <a class="btn btn-warning btn-big"  href="index.html">返回操作</a> </div>
          </div>
        </div>
      </div>
    </div>
